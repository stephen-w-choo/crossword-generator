...
def generate_crossword(structure, words):
    # structure and words will be a reference to a file

    # create a crossword object with the variable structure and the words that can be used
    crossword = Crossword(structure, words)

    # loads the crossword object into the creator singleton
